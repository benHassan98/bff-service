...
const APP_URL = process.env.APP_URL || 'http://frontend-service:5173';
const REDIRECT_URI = process.env.REDIRECT_URI || 'http://bff-service:8080/oauth2/code';
const AUTH_SERVER = process.env.AUTH_SERVER || "http://auth-server:8080";
const ACCOUNT_SERVICE = process.env.ACCOUNT_SERVICE || "http://gateway-service:8080/account-service";
